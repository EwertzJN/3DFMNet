...
from configs.config_xyzibd_focus import config
from utils.dataset import XYZIBD_train_data_loader
...
def make_parser():
    ...
    parser.add_argument('--output_dir', type=str, default='./output/xyzibd/detection_exp1')
    parser.add_argument('--snapshot_dir', type=str, default='./output/xyzibd/detection_exp1/snapshots')
    parser.add_argument('--logs_dir', type=str, default='./output/xyzibd/detection_exp1/logs')
    parser.add_argument('--xyzibd_root', type=str, default='/home/jewertz/bop/xyzibd')
    return parser
...
def main():
    ...
    config.xyzibd_root = args.xyzibd_root
    ...
    with Engine(log_file=log_file, default_parser=parser, seed=config.seed) as engine:
        ...
        train_loader, valid_loader, neighborhood_limits = XYZIBD_train_data_loader(engine, config)
