...
def get_node_corr_indices_and_overlaps(
    ...
    """
    # breakpoint()
    src_node_centers = torch.mean(src_nodes, dim=0).unsqueeze(0)
    node_centers = apply_transform(src_node_centers, transform).squeeze(1)
    ...
    return corr_indices, corr_overlaps, node_centers
