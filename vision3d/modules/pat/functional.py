...
import vision3d.modules.kpconv.functional
...
def farthest_point_sampling_and_gather(points, features, num_sample):
    ...
    points = vision3d.modules.kpconv.functional.gather(points, indices)
    if features is not None:
        features = vision3d.modules.kpconv.functional.gather(features, indices)
