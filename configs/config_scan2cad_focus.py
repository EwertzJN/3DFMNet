...
# config.root_dir = '/home/zhangliyuan/mycode/nips24/exp/MIRETR'
# config.output_dir = osp.join(config.root_dir, 'output', 'scan2cad', 'exp3')
...
# config.dataset_root = '/home/yzy/Desktop/icmi'
# config.robi_root = '/home/yzy/Desktop/robi/'
config.scannet_root = '/data1/local_userdata/zhangliyuan/dataset/NIPS2024/scannet_ply/scans'
config.shapenet_root = '/data1/local_userdata/zhangliyuan/dataset/NIPS2024/ShapeNet/ShapeNetCore.v2'
config.scan2cad_root = '/data1/local_userdata/zhangliyuan/dataset/NIPS2024/scan2cad/scan2cad.npy'
config.scan2cad = '/data1/local_userdata/zhangliyuan/dataset/NIPS2024/scan2cad/full_annotations.json'
config.process_scan2cad_root = '/data1/local_userdata/zhangliyuan/dataset/NIPS2024/dataset_generate/scan2cad/scan2cad_pre/'
...
config.coarse_matching_pos_radius = 1.5 * config.voxel_size
config.coarse_matching_safe_radius = 5 * config.voxel_size

# loss - Fine level
config.fine_sinkhorn_loss_positive_radius = config.voxel_size * 2
config.dbscan_eps = config.voxel_size
config.dbscan_min_samples = 2

# loss - Overall
config.weight_coarse_loss = 1.
config.weight_instance_score=5.
config.weight_center_norm_loss = 5.
config.weight_center_dir_loss = 1.
