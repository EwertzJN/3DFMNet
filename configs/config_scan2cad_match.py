...
# config.root_dir = '/home/zhangliyuan/mycode/nips24/baseline/MIRETR'
# config.working_dir = osp.dirname(osp.realpath(__file__))
# config.program_name = osp.basename(config.working_dir)
# config.output_dir = osp.join('/data1/local_userdata/zhangliyuan/log/NIPS24/baseline', config.program_name, 'exp6')
...
config.process_scan2cad_root = '/data1/local_userdata/zhangliyuan/dataset/NIPS2024/dataset_generate/scan2cad/scan2cad_last_random_4096/'
# config.process_scan2cad_root = '/data1/local_userdata/zhangliyuan/dataset/NIPS2024/dataset_generate/scan2cad/scan2cad_gt_center/'
...
config.weight_overlap_mask_loss = 0.5
# Eval - Overall 
