...
from vision3d.utils.point_cloud_utils import get_point_to_node_indices_and_masks,pairwise_distance,farthest_point_sample,get_knn_indices,get_compatibility,get_point2trans_index, apply_transform
...
class MatchNet(nn.Module):
    def __init__(self, config):
        ...
        self.overlap_mask_thre=config.overlap_mask_thre
        self.eval_iou=False
    ...
    def forward(self, data_dict):
        ...
        if self.training:
            ...
            # process attention and compute instance mask
            ...
            with torch.no_grad():
                ...
                pred_instance_label = pred_instance_score.sigmoid() > self.overlap_mask_thre
